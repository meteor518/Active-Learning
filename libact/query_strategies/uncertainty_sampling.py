...
from libact.query_strategies.multi_argmax import multi_argmax
...
class UncertaintySampling(QueryStrategy):
    ...
    def make_query(self, return_score=False, return_label=False, n_instances=1):
        ...
        if return_score and return_label:
            pre_label = np.argmax(dvalue, axis=1)
            return unlabeled_entry_ids[ask_ids], score[ask_ids], pre_label[ask_ids]
        elif return_score:
